module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        copy: {
            main: {
                src: 'lib/src/angular-snippet-sample.js',
                dest: 'lib/dist/js/angular-snippet-sample.js'
            }
        },
        ...
        uglify: {
            minify: {
                files: {
                    'lib/dist/js/angular-snippet-sample.min.js': ['lib/dist/js/angular-snippet-sample.js']
                }
            }
        },
